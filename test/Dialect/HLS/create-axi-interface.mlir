// RUN: sar-opt -hls-create-axi-interface %s | FileCheck %s

// The top function's ports are the design's contract with its host: the
// kernel's own arrays, then one scratch pointer. The six buffers this
// module keeps in DRAM are internal, so they are carved out of that one
// allocation at compile-time offsets (`scratch_bytes` records what the
// caller must allocate) instead of becoming six more ports.
...
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node7(%arg0: memref<602112xi8, #hls.mem<dram>>, %arg1: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK: affine.for %arg5 = 0 to 16 {
// CHECK: affine.for %arg6 = 0 to 14 {
// CHECK: affine.for %arg7 = 0 to 14 {
// CHECK: %0 = affine.load %arg0[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 501760] : memref<602112xi8, #hls.mem<dram>>
...
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node5(%arg0: !hls.stream<i1, 1>, %arg1: memref<602112xi8, #hls.mem<dram>>, %arg2: memref<64xi8, #hls.mem<bram_t2p>>) {
...
// CHECK: func.call @forward_node7(%arg1, %3, %0, %2, %1) : (memref<602112xi8, #hls.mem<dram>>, memref<16x14x14xi8, #hls.mem<bram_t2p>>, index, index, index) -> ()
...
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node9(%arg0: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg1: memref<602112xi8, #hls.mem<dram>>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK: affine.for %arg5 = 0 to 16 {
// CHECK: affine.for %arg6 = 0 to 14 {
// CHECK: affine.for %arg7 = 0 to 14 {
// CHECK: %0 = affine.load %arg0[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: affine.store %0, %arg1[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 501760] : memref<602112xi8, #hls.mem<dram>>
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node10(%arg0: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg1: memref<602112xi8, #hls.mem<dram>>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK: affine.for %arg5 = 0 to 16 {
// CHECK: affine.for %arg6 = 0 to 14 {
// CHECK: affine.for %arg7 = 0 to 14 {
// CHECK: %0 = affine.load %arg0[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: affine.store %0, %arg1[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 551936] : memref<602112xi8, #hls.mem<dram>>
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: return
...
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node12(%arg0: memref<602112xi8, #hls.mem<dram>>, %arg1: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK: affine.for %arg5 = 0 to 16 {
// CHECK: affine.for %arg6 = 0 to 14 {
// CHECK: affine.for %arg7 = 0 to 14 {
// CHECK: %0 = affine.load %arg0[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 451584] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %0, %arg1[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node13(%arg0: memref<602112xi8, #hls.mem<dram>>, %arg1: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK: affine.for %arg5 = 0 to 16 {
// CHECK: affine.for %arg6 = 0 to 14 {
// CHECK: affine.for %arg7 = 0 to 14 {
// CHECK: %0 = affine.load %arg0[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 551936] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %0, %arg1[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: } {parallel}
...
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node15(%arg0: memref<602112xi8, #hls.mem<dram>>, %arg1: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK: affine.for %arg5 = 0 to 16 {
// CHECK: affine.for %arg6 = 0 to 14 {
// CHECK: affine.for %arg7 = 0 to 14 {
// CHECK: %0 = affine.load %arg0[(%arg5 + symbol(%arg2) * 16) * 3136 + (%arg6 * 2 + symbol(%arg3) * 28) * 56 + %arg7 * 2 + symbol(%arg4) * 28] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %0, %arg1[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node8(%arg0: !hls.stream<i1, 3>, %arg1: memref<602112xi8, #hls.mem<dram>>, %arg2: memref<64x64xi8, #hls.mem<dram>>, %arg3: !hls.stream<i1, 1>, %arg4: memref<602112xi8, #hls.mem<dram>>, %arg5: memref<602112xi8, #hls.mem<dram>>, %arg6: !hls.stream<i1, 1>, %arg7: memref<602112xi8, #hls.mem<dram>>, %arg8: memref<602112xi8, #hls.mem<dram>>) {
...
// CHECK: func.call @forward_node15(%arg1, %8, %3, %1, %0) : (memref<602112xi8, #hls.mem<dram>>, memref<16x14x14xi8, #hls.mem<bram_t2p>>, index, index, index) -> ()
// CHECK: func.call @forward_node14(%arg2, %7, %2, %3) : (memref<64x64xi8, #hls.mem<dram>>, memref<16x16xi8, #hls.mem<bram_t2p>>, index, index) -> ()
// CHECK: func.call @forward_node13(%arg5, %6, %2, %1, %0) : (memref<602112xi8, #hls.mem<dram>>, memref<16x14x14xi8, #hls.mem<bram_t2p>>, index, index, index) -> ()
// CHECK: func.call @forward_node12(%arg4, %5, %2, %1, %0) : (memref<602112xi8, #hls.mem<dram>>, memref<16x14x14xi8, #hls.mem<bram_t2p>>, index, index, index) -> ()
...
// CHECK: func.call @forward_node10(%9, %arg8, %2, %1, %0) : (memref<16x14x14xi8, #hls.mem<bram_t2p>>, memref<602112xi8, #hls.mem<dram>>, index, index, index) -> ()
// CHECK: func.call @forward_node9(%4, %arg7, %2, %1, %0) : (memref<16x14x14xi8, #hls.mem<bram_t2p>>, memref<602112xi8, #hls.mem<dram>>, index, index, index) -> ()
// CHECK: } {loop_directive = #hls.loop<pipeline = false, target_ii = 1, dataflow = true, flatten = false>}
// CHECK: hls.dataflow.stream_write %arg6, %true : <i1, 1>, i1
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node17(%arg0: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg1: memref<602112xi8, #hls.mem<dram>>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK: affine.for %arg5 = 0 to 16 {
// CHECK: affine.for %arg6 = 0 to 14 step 2 {
// CHECK: affine.for %arg7 = 0 to 14 step 2 {
// CHECK: %0 = affine.load %arg0[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: affine.store %0, %arg1[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 451584] : memref<602112xi8, #hls.mem<dram>>
// CHECK: %1 = affine.load %arg0[%arg5, %arg6, %arg7 + 1] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: affine.store %1, %arg1[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 1 + 451584] : memref<602112xi8, #hls.mem<dram>>
// CHECK: %2 = affine.load %arg0[%arg5, %arg6 + 1, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: affine.store %2, %arg1[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14 + 1) * 28 + %arg7 + symbol(%arg4) * 14 + 451584] : memref<602112xi8, #hls.mem<dram>>
// CHECK: %3 = affine.load %arg0[%arg5, %arg6 + 1, %arg7 + 1] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: affine.store %3, %arg1[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14 + 1) * 28 + %arg7 + symbol(%arg4) * 14 + 1 + 451584] : memref<602112xi8, #hls.mem<dram>>
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: return
...
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node19(%arg0: memref<602112xi8, #hls.mem<dram>>, %arg1: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK: affine.for %arg5 = 0 to 16 {
// CHECK: affine.for %arg6 = 0 to 14 step 2 {
// CHECK: affine.for %arg7 = 0 to 14 step 2 {
// CHECK: %0 = affine.load %arg0[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 451584] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %0, %arg1[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: %1 = affine.load %arg0[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 1 + 451584] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %1, %arg1[%arg5, %arg6, %arg7 + 1] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: %2 = affine.load %arg0[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14 + 1) * 28 + %arg7 + symbol(%arg4) * 14 + 451584] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %2, %arg1[%arg5, %arg6 + 1, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: %3 = affine.load %arg0[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14 + 1) * 28 + %arg7 + symbol(%arg4) * 14 + 1 + 451584] : memref<602112xi8, #hls.mem<dram>>
...
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node21(%arg0: memref<602112xi8, #hls.mem<dram>>, %arg1: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg2: index, %arg3: index, %arg4: index, %arg5: index, %arg6: index) attributes {inline} {
// CHECK: affine.for %arg7 = 0 to 16 {
// CHECK: affine.for %arg8 = 0 to 14 step 2 {
// CHECK: affine.for %arg9 = 0 to 14 step 2 {
// CHECK: %0 = affine.load %arg0[(%arg7 + symbol(%arg2) * 16) * 784 + (%arg8 + symbol(%arg3) + symbol(%arg4) * 14 - 1) * 28 + %arg9 + symbol(%arg5) + symbol(%arg6) * 14 - 1 + 401408] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %0, %arg1[%arg7, %arg8, %arg9] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: %1 = affine.load %arg0[(%arg7 + symbol(%arg2) * 16) * 784 + (%arg8 + symbol(%arg3) + symbol(%arg4) * 14 - 1) * 28 + %arg9 + symbol(%arg5) + symbol(%arg6) * 14 + 401408] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %1, %arg1[%arg7, %arg8, %arg9 + 1] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: %2 = affine.load %arg0[(%arg7 + symbol(%arg2) * 16) * 784 + (%arg8 + symbol(%arg3) + symbol(%arg4) * 14) * 28 + %arg9 + symbol(%arg5) + symbol(%arg6) * 14 - 1 + 401408] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %2, %arg1[%arg7, %arg8 + 1, %arg9] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: %3 = affine.load %arg0[(%arg7 + symbol(%arg2) * 16) * 784 + (%arg8 + symbol(%arg3) + symbol(%arg4) * 14) * 28 + %arg9 + symbol(%arg5) + symbol(%arg6) * 14 + 401408] : memref<602112xi8, #hls.mem<dram>>
...
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node16(%arg0: memref<64x64x3x3xi8, #hls.mem<dram>>, %arg1: !hls.stream<i1, 1>, %arg2: memref<602112xi8, #hls.mem<dram>>, %arg3: memref<602112xi8, #hls.mem<dram>>, %arg4: !hls.stream<i1, 1>, %arg5: memref<602112xi8, #hls.mem<dram>>) {
// CHECK: %true = arith.constant true
...
// CHECK: func.call @forward_node21(%arg2, %8, %5, %4, %1, %3, %0) : (memref<602112xi8, #hls.mem<dram>>, memref<16x14x14xi8, #hls.mem<bram_t2p>>, index, index, index, index, index) -> ()
...
// CHECK: func.call @forward_node19(%arg3, %6, %2, %1, %0) : (memref<602112xi8, #hls.mem<dram>>, memref<16x14x14xi8, #hls.mem<bram_t2p>>, index, index, index) -> ()
// CHECK: %9 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, #hls.mem<bram_t2p>>
...
// CHECK: func.call @forward_node17(%9, %arg5, %2, %1, %0) : (memref<16x14x14xi8, #hls.mem<bram_t2p>>, memref<602112xi8, #hls.mem<dram>>, index, index, index) -> ()
// CHECK: } {loop_directive = #hls.loop<pipeline = false, target_ii = 1, dataflow = true, flatten = false>}
// CHECK: hls.dataflow.stream_write %arg4, %true : <i1, 1>, i1
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node23(%arg0: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg1: memref<602112xi8, #hls.mem<dram>>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK: affine.for %arg5 = 0 to 16 {
// CHECK: affine.for %arg6 = 0 to 14 step 2 {
// CHECK: affine.for %arg7 = 0 to 14 step 2 {
// CHECK: %0 = affine.load %arg0[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: affine.store %0, %arg1[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 401408] : memref<602112xi8, #hls.mem<dram>>
// CHECK: %1 = affine.load %arg0[%arg5, %arg6, %arg7 + 1] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: affine.store %1, %arg1[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 1 + 401408] : memref<602112xi8, #hls.mem<dram>>
// CHECK: %2 = affine.load %arg0[%arg5, %arg6 + 1, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: affine.store %2, %arg1[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14 + 1) * 28 + %arg7 + symbol(%arg4) * 14 + 401408] : memref<602112xi8, #hls.mem<dram>>
// CHECK: %3 = affine.load %arg0[%arg5, %arg6 + 1, %arg7 + 1] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: affine.store %3, %arg1[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14 + 1) * 28 + %arg7 + symbol(%arg4) * 14 + 1 + 401408] : memref<602112xi8, #hls.mem<dram>>
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: return
...
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node25(%arg0: memref<602112xi8, #hls.mem<dram>>, %arg1: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg2: index, %arg3: index, %arg4: index) attributes {inline} {
// CHECK: affine.for %arg5 = 0 to 16 {
// CHECK: affine.for %arg6 = 0 to 14 step 2 {
// CHECK: affine.for %arg7 = 0 to 14 step 2 {
// CHECK: %0 = affine.load %arg0[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 401408] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %0, %arg1[%arg5, %arg6, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: %1 = affine.load %arg0[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14) * 28 + %arg7 + symbol(%arg4) * 14 + 1 + 401408] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %1, %arg1[%arg5, %arg6, %arg7 + 1] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: %2 = affine.load %arg0[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14 + 1) * 28 + %arg7 + symbol(%arg4) * 14 + 401408] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %2, %arg1[%arg5, %arg6 + 1, %arg7] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: %3 = affine.load %arg0[(%arg5 + symbol(%arg2) * 16) * 784 + (%arg6 + symbol(%arg3) * 14 + 1) * 28 + %arg7 + symbol(%arg4) * 14 + 1 + 401408] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %3, %arg1[%arg5, %arg6 + 1, %arg7 + 1] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: } {parallel}
...
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node27(%arg0: memref<602112xi8, #hls.mem<dram>>, %arg1: memref<16x14x14xi8, #hls.mem<bram_t2p>>, %arg2: index, %arg3: index, %arg4: index, %arg5: index, %arg6: index) attributes {inline} {
// CHECK: affine.for %arg7 = 0 to 16 {
// CHECK: affine.for %arg8 = 0 to 14 step 2 {
// CHECK: affine.for %arg9 = 0 to 14 step 2 {
// CHECK: %0 = affine.load %arg0[(%arg7 + symbol(%arg2) * 16) * 3136 + (%arg8 * 2 + symbol(%arg3) + symbol(%arg4) * 28 - 1) * 56 + %arg9 * 2 + symbol(%arg5) + symbol(%arg6) * 28 - 1 + 200704] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %0, %arg1[%arg7, %arg8, %arg9] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: %1 = affine.load %arg0[(%arg7 + symbol(%arg2) * 16) * 3136 + (%arg8 * 2 + symbol(%arg3) + symbol(%arg4) * 28 - 1) * 56 + %arg9 * 2 + symbol(%arg5) + symbol(%arg6) * 28 + 1 + 200704] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %1, %arg1[%arg7, %arg8, %arg9 + 1] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: %2 = affine.load %arg0[(%arg7 + symbol(%arg2) * 16) * 3136 + (%arg8 * 2 + symbol(%arg3) + symbol(%arg4) * 28 + 1) * 56 + %arg9 * 2 + symbol(%arg5) + symbol(%arg6) * 28 - 1 + 200704] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %2, %arg1[%arg7, %arg8 + 1, %arg9] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: %3 = affine.load %arg0[(%arg7 + symbol(%arg2) * 16) * 3136 + (%arg8 * 2 + symbol(%arg3) + symbol(%arg4) * 28 + 1) * 56 + %arg9 * 2 + symbol(%arg5) + symbol(%arg6) * 28 + 1 + 200704] : memref<602112xi8, #hls.mem<dram>>
// CHECK: affine.store %3, %arg1[%arg7, %arg8 + 1, %arg9 + 1] : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node22(%arg0: !hls.stream<i1, 1>, %arg1: memref<602112xi8, #hls.mem<dram>>, %arg2: memref<64x64x3x3xi8, #hls.mem<dram>>, %arg3: memref<602112xi8, #hls.mem<dram>>, %arg4: !hls.stream<i1, 1>, %arg5: memref<602112xi8, #hls.mem<dram>>) {
// CHECK: %true = arith.constant true
// CHECK: hls.dataflow.stream_read %arg0 : (!hls.stream<i1, 1>) -> ()
// CHECK: affine.for %arg6 = 0 to 576 {
// CHECK: %0 = affine.apply #map5(%arg6)
...
// CHECK: %7 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x16xi8, #hls.mem<bram_t2p>>
// CHECK: %8 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, #hls.mem<bram_t2p>>
// CHECK: func.call @forward_node27(%arg1, %8, %5, %4, %1, %3, %0) : (memref<602112xi8, #hls.mem<dram>>, memref<16x14x14xi8, #hls.mem<bram_t2p>>, index, index, index, index, index) -> ()
...
// CHECK: func.call @forward_node25(%arg3, %6, %2, %1, %0) : (memref<602112xi8, #hls.mem<dram>>, memref<16x14x14xi8, #hls.mem<bram_t2p>>, index, index, index) -> ()
// CHECK: %9 = hls.dataflow.buffer {depth = 1 : i32} : memref<16x14x14xi8, #hls.mem<bram_t2p>>
...
// CHECK: func.call @forward_node23(%9, %arg5, %2, %1, %0) : (memref<16x14x14xi8, #hls.mem<bram_t2p>>, memref<602112xi8, #hls.mem<dram>>, index, index, index) -> ()
// CHECK: } {loop_directive = #hls.loop<pipeline = false, target_ii = 1, dataflow = true, flatten = false>}
// CHECK: hls.dataflow.stream_write %arg4, %true : <i1, 1>, i1
// CHECK: return
// CHECK: }
// CHECK: func.func @forward_node28(%arg0: !hls.stream<i1, 1>, %arg1: memref<64x56x56xi8, #hls.mem<dram>>, %arg2: !hls.stream<i1, 3>, %arg3: memref<602112xi8, #hls.mem<dram>>, %arg4: !hls.stream<i1, 1>, %arg5: memref<602112xi8, #hls.mem<dram>>) {
// CHECK: %true = arith.constant true
// CHECK: hls.dataflow.stream_read %arg0 : (!hls.stream<i1, 1>) -> ()
...
// CHECK: affine.store %0, %arg3[%arg6 * 3136 + %arg7 * 56 + %arg8] : memref<602112xi8, #hls.mem<dram>>
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: affine.for %arg6 = 0 to 64 {
...
// CHECK: affine.for %arg8 = 0 to 56 {
// CHECK: %0 = affine.load %arg1[%arg6, %arg7, %arg8] : memref<64x56x56xi8, #hls.mem<dram>>
// CHECK: affine.store %0, %arg5[%arg6 * 3136 + %arg7 * 56 + %arg8 + 200704] : memref<602112xi8, #hls.mem<dram>>
// CHECK: } {parallel}
// CHECK: } {parallel}
// CHECK: } {parallel}
...
// CHECK: return
// CHECK: }
// CHECK: func.func @forward(%arg0: !hls.axi<memref<64x56x56xi8, #hls.mem<dram>>>, %arg1: !hls.axi<memref<1000x64xi8, #hls.mem<dram>>>, %arg2: !hls.axi<memref<64x64xi8, #hls.mem<dram>>>, %arg3: !hls.axi<memref<64x64x3x3xi8, #hls.mem<dram>>>, %arg4: !hls.axi<memref<64x64x3x3xi8, #hls.mem<dram>>>, %arg5: !hls.axi<memref<1000xi8, #hls.mem<dram>>>, %arg6: !hls.axi<memref<602112xi8, #hls.mem<dram>>>) attributes {func_directive = #hls.func<pipeline = false, target_interval = 1, dataflow = true>, scratch_bytes = 602112 : i64, top_func} {
// CHECK: %0 = hls.axi.bundle "axi_0" : <i8, mm>
// CHECK: %1 = hls.axi.port %0, %arg6 : <i8, mm>, (!hls.axi<memref<602112xi8, #hls.mem<dram>>>) -> memref<602112xi8, #hls.mem<dram>>
// CHECK: %2 = hls.axi.port %0, %arg5 : <i8, mm>, (!hls.axi<memref<1000xi8, #hls.mem<dram>>>) -> memref<1000xi8, #hls.mem<dram>>
// CHECK: %3 = hls.axi.port %0, %arg4 : <i8, mm>, (!hls.axi<memref<64x64x3x3xi8, #hls.mem<dram>>>) -> memref<64x64x3x3xi8, #hls.mem<dram>>
// CHECK: %4 = hls.axi.port %0, %arg3 : <i8, mm>, (!hls.axi<memref<64x64x3x3xi8, #hls.mem<dram>>>) -> memref<64x64x3x3xi8, #hls.mem<dram>>
// CHECK: %5 = hls.axi.port %0, %arg2 : <i8, mm>, (!hls.axi<memref<64x64xi8, #hls.mem<dram>>>) -> memref<64x64xi8, #hls.mem<dram>>
// CHECK: %6 = hls.axi.port %0, %arg1 : <i8, mm>, (!hls.axi<memref<1000x64xi8, #hls.mem<dram>>>) -> memref<1000x64xi8, #hls.mem<dram>>
// CHECK: %7 = hls.axi.port %0, %arg0 : <i8, mm>, (!hls.axi<memref<64x56x56xi8, #hls.mem<dram>>>) -> memref<64x56x56xi8, #hls.mem<dram>>
// CHECK: %8 = hls.dataflow.stream {depth = 1 : i32} : <i1, 1>
// CHECK: call @forward_node29(%7, %8, %7) : (memref<64x56x56xi8, #hls.mem<dram>>, !hls.stream<i1, 1>, memref<64x56x56xi8, #hls.mem<dram>>) -> ()
// CHECK: %9 = hls.dataflow.stream {depth = 3 : i32} : <i1, 3>
// CHECK: %10 = hls.dataflow.stream {depth = 1 : i32} : <i1, 1>
// CHECK: call @forward_node28(%8, %7, %9, %1, %10, %1) : (!hls.stream<i1, 1>, memref<64x56x56xi8, #hls.mem<dram>>, !hls.stream<i1, 3>, memref<602112xi8, #hls.mem<dram>>, !hls.stream<i1, 1>, memref<602112xi8, #hls.mem<dram>>) -> ()
// CHECK: %11 = hls.dataflow.stream {depth = 1 : i32} : <i1, 1>
// CHECK: call @forward_node22(%10, %1, %3, %1, %11, %1) : (!hls.stream<i1, 1>, memref<602112xi8, #hls.mem<dram>>, memref<64x64x3x3xi8, #hls.mem<dram>>, memref<602112xi8, #hls.mem<dram>>, !hls.stream<i1, 1>, memref<602112xi8, #hls.mem<dram>>) -> ()
// CHECK: %12 = hls.dataflow.stream {depth = 1 : i32} : <i1, 1>
// CHECK: call @forward_node16(%4, %11, %1, %1, %12, %1) : (memref<64x64x3x3xi8, #hls.mem<dram>>, !hls.stream<i1, 1>, memref<602112xi8, #hls.mem<dram>>, memref<602112xi8, #hls.mem<dram>>, !hls.stream<i1, 1>, memref<602112xi8, #hls.mem<dram>>) -> ()
// CHECK: %13 = hls.dataflow.stream {depth = 1 : i32} : <i1, 1>
// CHECK: call @forward_node8(%9, %1, %5, %12, %1, %1, %13, %1, %1) : (!hls.stream<i1, 3>, memref<602112xi8, #hls.mem<dram>>, memref<64x64xi8, #hls.mem<dram>>, !hls.stream<i1, 1>, memref<602112xi8, #hls.mem<dram>>, memref<602112xi8, #hls.mem<dram>>, !hls.stream<i1, 1>, memref<602112xi8, #hls.mem<dram>>, memref<602112xi8, #hls.mem<dram>>) -> ()
// CHECK: %14 = hls.dataflow.buffer {depth = 1 : i32, init_value = -24 : i8} : memref<64xi8, #hls.mem<bram_t2p>>
// CHECK: call @forward_node5(%13, %1, %14) : (!hls.stream<i1, 1>, memref<602112xi8, #hls.mem<dram>>, memref<64xi8, #hls.mem<bram_t2p>>) -> ()
// CHECK: call @forward_node0(%14, %6, %2, %2) : (memref<64xi8, #hls.mem<bram_t2p>>, memref<1000x64xi8, #hls.mem<dram>>, memref<1000xi8, #hls.mem<dram>>, memref<1000xi8, #hls.mem<dram>>) -> ()
// CHECK: return
// CHECK: }
...
// CHECK: %0 = hls.dataflow.buffer {depth = 1 : i32, init_value = -24 : i8} : memref<602112xi8, #hls.mem<dram>>
// CHECK: %1 = hls.axi.pack %arg0 : (memref<64x56x56xi8, #hls.mem<dram>>) -> !hls.axi<memref<64x56x56xi8, #hls.mem<dram>>>
// CHECK: %2 = hls.axi.pack %arg1 : (memref<1000x64xi8, #hls.mem<dram>>) -> !hls.axi<memref<1000x64xi8, #hls.mem<dram>>>
// CHECK: %3 = hls.axi.pack %arg2 : (memref<64x64xi8, #hls.mem<dram>>) -> !hls.axi<memref<64x64xi8, #hls.mem<dram>>>
// CHECK: %4 = hls.axi.pack %arg3 : (memref<64x64x3x3xi8, #hls.mem<dram>>) -> !hls.axi<memref<64x64x3x3xi8, #hls.mem<dram>>>
// CHECK: %5 = hls.axi.pack %arg4 : (memref<64x64x3x3xi8, #hls.mem<dram>>) -> !hls.axi<memref<64x64x3x3xi8, #hls.mem<dram>>>
// CHECK: %6 = hls.axi.pack %arg5 : (memref<1000xi8, #hls.mem<dram>>) -> !hls.axi<memref<1000xi8, #hls.mem<dram>>>
// CHECK: %7 = hls.axi.pack %0 : (memref<602112xi8, #hls.mem<dram>>) -> !hls.axi<memref<602112xi8, #hls.mem<dram>>>
// CHECK: call @forward(%1, %2, %3, %4, %5, %6, %7) : (!hls.axi<memref<64x56x56xi8, #hls.mem<dram>>>, !hls.axi<memref<1000x64xi8, #hls.mem<dram>>>, !hls.axi<memref<64x64xi8, #hls.mem<dram>>>, !hls.axi<memref<64x64x3x3xi8, #hls.mem<dram>>>, !hls.axi<memref<64x64x3x3xi8, #hls.mem<dram>>>, !hls.axi<memref<1000xi8, #hls.mem<dram>>>, !hls.axi<memref<602112xi8, #hls.mem<dram>>>) -> ()
// CHECK: return
// CHECK: }
// CHECK: }
// CHECK-EMPTY:
