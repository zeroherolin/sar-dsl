...
// CHECK-DAG: memref.global "private" constant @__sar_fft_twiddle_cos_7_f64 : memref<7xf64>
// CHECK-DAG: memref.global "private" constant @__sar_fft_twiddle_sin_7_f64 : memref<7xf64>
...
func.func @fft_split_2d(%re: tensor<4x8xf64>, %im: tensor<4x8xf64>)
  ...
  // CHECK: memref.get_global @__sar_fft_twiddle_cos_7_f64
