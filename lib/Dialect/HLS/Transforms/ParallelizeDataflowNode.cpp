...
#include "sar/Dialect/HLS/IR/Analysis.h"
...
struct ParallelizeDataflowNode
    : public sar::impl::ParallelizeDataflowNodeBase<ParallelizeDataflowNode> {
...
std::unique_ptr<Pass> sar::createParallelizeDataflowNodePass(
