...
static_assert(WKA_COMPLEX_SAMPLE_BITS == 64,
              "Memory packing requires 64-bit complex samples.");
static_assert(
...
static_assert((N % WKA_FFT_PAR_ROWS) == 0,
              "WKA_N must be divisible by WKA_FFT_PAR_ROWS.");
static_assert((N % WKA_STOLT_OUT_LANES) == 0,
